    ...
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className={`flex flex-row justify-between items-center w-full`}>
          <h1 className="flex-1 font-poppins  font-medium ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]">
        ...
        <h1 className="flex-1 font-poppins  font-medium ss:text-[68px] text-[52px] text-white ss:leading-[100px] w-full">Payment Method.</h1>
      ...
      <div className={`flex flex-1 ${styles.flexCenter} md:my-0 my-10 relative`}>
        <img src={robot} alt="billing" className="w-[100p%] h-[100%] relative z-[5]" />
